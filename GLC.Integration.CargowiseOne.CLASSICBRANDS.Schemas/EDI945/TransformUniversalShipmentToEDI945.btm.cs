  ...
  <xsl:template match=""/s0:UniversalShipment"">
    ...
    <ns0:X12_00401_945>
      ...
      <ns0:N9>
        ...
        <xsl:for-each select=""//s0:CustomizedFieldCollection/s0:CustomizedField"">
          <xsl:if test=""s0:Key/text()='LoadNumber'"">
            <N904>
              <xsl:value-of select=""s0:Value/text()""/>
            </N904>
          </xsl:if>
  ...
  <ns0:LXLoop1>
      ...
      <xsl:for-each select=""s0:Shipment/s0:Order/s0:OrderLineCollection/s0:OrderLine"">
       <xsl:variable name=""varprodcodelist"" select =""s0:Product/s0:Code/text()""/>
        ...
        <xsl:variable name=""varorderqty"" select=""s0:OrderedQty/text()""/>
        ...
        <xsl:variable name=""varbuyerca"" select=""s0:CustomizedFieldCollection/s0:CustomizedField[5]/s0:Value/text()""/>
                  ...
                  <xsl:for-each select=""s0:PackedItem"">
                   ...
                   <ns0:W12Loop1>
                      <ns0:W12>
                        ...
                        <!--<xsl:variable name=""varProdcode"" select=""ScriptNS0:GetProdCode(s0:Description/text())""/>--><!--
                        <xsl:variable name=""varQuantity"" select=""ScriptNS0:Get945convPCE(s0:Product/s0:Code/text(),userCSharp:replacefunc($varctn))""/>
                        <xsl:variable name=""varw1203"" select=""ScriptNS0:Get945convPCE(s0:Product/s0:Code/text(),userCSharp:replacefunc($varorderqty))""/>-->
